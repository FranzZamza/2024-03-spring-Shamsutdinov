...
public class SecurityBookControllerTest {
    ...
    static Stream<Arguments> argumentsBookAuthorizedRequests() {
        var expectedBookDto = expectedBookDtos.get(0);
        return Stream.of(
    ...
    @ParameterizedTest
    @MethodSource("argumentsBookAuthorizedRequests")
    @DisplayName("должен все аутифицированные запросы корректно обработать")
